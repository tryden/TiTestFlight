...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','co.saiten.ti.testflight.js')
	...
	f = os.path.join(cwd,'Classes','CoSaitenTiTestflightModuleAssets.m')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','co.saiten.ti.testflight.js']
